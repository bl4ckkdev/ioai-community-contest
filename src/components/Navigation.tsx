    ...
    <>
      <div className="fixed top-0 left-0 right-0 z-50">
        <div className={`absolute inset-x-0 top-0 h-20 transition-opacity duration-300 ${!isScrolled ? 'opacity-100' : 'opacity-0'}`}>
          <div className="absolute left-1/2 -translate-x-1/2 bottom-0 w-[150%] h-20 bg-gradient-to-r from-aicc-purple/100 via-aicc-orange/100 blur-2xl" />
        </div> 

        <div className={`absolute inset-x-0 top-5 transition-opacity shadow-sm duration-300 ${isScrolled ? 'opacity-100' : 'opacity-0'}`}/>

        <nav className="relative bg-white dark:bg-[#0a0a0f] border-b border-gray-200/50 dark:border-white/10">
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                className="hidden md:inline-flex items-center gap-2 px-5 py-2.5 btn-gradient text-white text-sm font-medium rounded-lg transition-all duration-300"
              >
      ...
      >
        <div className="flex flex-col h-full justify-center items-center space-y-8 p-8">
          ...
          <button
            ...
            className="mt-8 inline-flex items-center gap-2 px-8 py-4 btn-gradient text-white font-medium rounded-lg"
          >
